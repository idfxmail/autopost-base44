...
const {userPlatformDir}=require('../helpers/sessionStore');const {downloadImages}=require('../utils/downloadImages');const sel=require('../selectorMaps/yad2-rent.json');
...
return {link:link||'PUBLISHED_NO_LINK_FOUND',meta:{platform:'yad2-rent'}};} finally{await browser.close();}}
